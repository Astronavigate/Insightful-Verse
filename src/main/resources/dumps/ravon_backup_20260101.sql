...
\restrict 2ZXB5gM78gazN0nn9Ne3OcMKj0axhlsyOtPlBWFjyvbfyEc5o22rq9NKFpfJxwS
...
--
-- Name: content_type_enum; Type: TYPE; Schema: inver; Owner: ravon
--

CREATE TYPE inver.content_type_enum AS ENUM (
    'course',
    'files',
    'collection',
    'comment'
...
ALTER TYPE inver.content_type_enum OWNER TO ravon;
...
ALTER TABLE inver.annotations ALTER COLUMN note_id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME inver.annotations_note_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE inver.class ALTER COLUMN class_id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME inver.class_class_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE inver.collection_items ALTER COLUMN collection_item_id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME inver.collection_items_collection_item_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE inver.collections ALTER COLUMN collection_id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME inver.collections_collection_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE inver.comments (
    ...
    type inver.content_type_enum NOT NULL,
...
ALTER TABLE inver.comments ALTER COLUMN comment_id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME inver.comments_comment_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE inver.courses ALTER COLUMN course_id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME inver.courses_course_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE inver.files ALTER COLUMN file_id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME inver.files_file_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: question; Type: TABLE; Schema: inver; Owner: ravon
--

CREATE TABLE inver.question (
...
ALTER TABLE inver.question OWNER TO ravon;

--
-- Name: question_question_id_seq; Type: SEQUENCE; Schema: inver; Owner: ravon
--

ALTER TABLE inver.question ALTER COLUMN question_id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME inver.question_question_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE inver.reactions (
    ...
    user_id bigint NOT NULL,
    content_type inver.content_type_enum NOT NULL,
    related_id bigint NOT NULL,
...
ALTER TABLE inver.reactions ALTER COLUMN like_id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME inver.reactions_like_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: stu_assignments; Type: TABLE; Schema: inver; Owner: ravon
--

CREATE TABLE inver.stu_assignments (
...
ALTER TABLE inver.stu_assignments OWNER TO ravon;

--
-- Name: stu_assignments_submission_id_seq; Type: SEQUENCE; Schema: inver; Owner: ravon
--

ALTER TABLE inver.stu_assignments ALTER COLUMN submission_id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME inver.stu_assignments_submission_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE inver.test ALTER COLUMN test_id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME inver.test_test_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE inver.third_party_accounts ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME inver.third_party_accounts_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE inver.users ALTER COLUMN user_id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME inver.users_user_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE inver.view_records ALTER COLUMN record_id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME inver.view_records_record_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
1	10000000000	10000000033	bookmark	epubcfi(/6/6[item2]!/4/2[a002]/1:0)	test1	\N	2025-12-16 00:14:24	2025-12-16 00:14:24
7	10000000000	10000000033	bookmark	epubcfi(/6/12[item5]!/4/2[41-14488c5c3e8b491d97c21ee6fb56f687]/2/2/1:0)	shuqian	\N	2025-12-16 11:21:32	2025-12-16 11:21:32
29	10000000000	10000000033	bookmark	epubcfi(/6/8[item3]!/4/2[21-14488c5c3e8b491d97c21ee6fb56f687]/1:0)		\N	2025-12-16 21:50:03	2025-12-16 21:50:03
...
38	10000000000	10000000033	bookmark	epubcfi(/6/100[item49]!/4/2[a049]/1:0)	书签123	\N	2025-12-20 21:29:56	2025-12-20 21:29:56
...
COPY inver.collection_items (collection_item_id, item_id, item_type, create_at) FROM stdin;
\.
...
COPY inver.collections (collection_id, user_id, name, description, create_at) FROM stdin;
\.
...
COPY inver.comments (comment_id, user_id, content, type, related_id, created_at) FROM stdin;
\.
...
--
-- Data for Name: question; Type: TABLE DATA; Schema: inver; Owner: ravon
--

COPY inver.question (question_id, test_id, submitter_id, question_score, submission_date, question_content, question_answer) FROM stdin;
\.
...
COPY inver.reactions (like_id, user_id, content_type, related_id, action) FROM stdin;
\.


--
-- Data for Name: stu_assignments; Type: TABLE DATA; Schema: inver; Owner: ravon
--

COPY inver.stu_assignments (submission_id, test_id, question_id, submitter_id, submission_date, stu_score) FROM stdin;
\.
...
COPY inver.third_party_accounts (id, user_id, third_party_id, provider_type) FROM stdin;
\.
...
SELECT pg_catalog.setval('inver.annotations_note_id_seq', 1, false);
...
SELECT pg_catalog.setval('inver.class_class_id_seq', 1, false);
...
SELECT pg_catalog.setval('inver.collection_items_collection_item_id_seq', 1, false);
...
SELECT pg_catalog.setval('inver.collections_collection_id_seq', 1, false);
...
SELECT pg_catalog.setval('inver.comments_comment_id_seq', 1, false);
...
SELECT pg_catalog.setval('inver.courses_course_id_seq', 1, false);
...
SELECT pg_catalog.setval('inver.files_file_id_seq', 1, false);


--
-- Name: question_question_id_seq; Type: SEQUENCE SET; Schema: inver; Owner: ravon
--

SELECT pg_catalog.setval('inver.question_question_id_seq', 1, false);
...
SELECT pg_catalog.setval('inver.reactions_like_id_seq', 1, false);


--
-- Name: stu_assignments_submission_id_seq; Type: SEQUENCE SET; Schema: inver; Owner: ravon
--

SELECT pg_catalog.setval('inver.stu_assignments_submission_id_seq', 1, false);
...
SELECT pg_catalog.setval('inver.test_test_id_seq', 1, false);
...
SELECT pg_catalog.setval('inver.third_party_accounts_id_seq', 1, false);
...
SELECT pg_catalog.setval('inver.users_user_id_seq', 1, false);
...
SELECT pg_catalog.setval('inver.view_records_record_id_seq', 1, false);
...
--
-- Name: question question_pkey; Type: CONSTRAINT; Schema: inver; Owner: ravon
--

ALTER TABLE ONLY inver.question
...
--
-- Name: stu_assignments stu_assignments_pkey; Type: CONSTRAINT; Schema: inver; Owner: ravon
--

ALTER TABLE ONLY inver.stu_assignments
    ADD CONSTRAINT stu_assignments_pkey PRIMARY KEY (submission_id);
...
ALTER TABLE ONLY inver.reactions
    ADD CONSTRAINT uq_user_content_action UNIQUE (user_id, content_type, related_id, action);
...
CREATE INDEX idx_question_submitter_id ON inver.question USING btree (submitter_id);
...
CREATE INDEX idx_question_test_id ON inver.question USING btree (test_id);


--
-- Name: idx_stu_assignments_submitter_id; Type: INDEX; Schema: inver; Owner: ravon
--

CREATE INDEX idx_stu_assignments_submitter_id ON inver.stu_assignments USING btree (submitter_id);


--
-- Name: idx_stu_assignments_test_id; Type: INDEX; Schema: inver; Owner: ravon
--

CREATE INDEX idx_stu_assignments_test_id ON inver.stu_assignments USING btree (test_id);
...
\unrestrict 2ZXB5gM78gazN0nn9Ne3OcMKj0axhlsyOtPlBWFjyvbfyEc5o22rq9NKFpfJxwS
