...
\restrict UXryPT7TQZBJ8kFtMI3rIOiYJ1TTw0H2lIuGImN0zqaeRrYTLpwcmU5rcFiUWf6
...
ALTER TABLE inver.questions ALTER COLUMN question_id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME inver.questions_question_id_seq
    START WITH 10000000000
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE inver.third_party_accounts ALTER COLUMN third_id ADD GENERATED BY DEFAULT AS IDENTITY (
...
COPY inver.answers (answer_id, question_id, submitter_id, answer_content, answer_score, submission_date, question_content, question_answer) FROM stdin;
\.
...
SELECT pg_catalog.setval('inver.questions_question_id_seq', 1, false);
...
\unrestrict UXryPT7TQZBJ8kFtMI3rIOiYJ1TTw0H2lIuGImN0zqaeRrYTLpwcmU5rcFiUWf6
