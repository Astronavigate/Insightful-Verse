...
\restrict y5aKQCKnbUIHlRiIY1xRiUhKRtjKvcl9plPhIxUF156BjEemEKwNK5BIGNWxves
...
--
-- Name: base; Type: SCHEMA; Schema: -; Owner: ravon
--

CREATE SCHEMA base;


ALTER SCHEMA base OWNER TO ravon;
...
ALTER SCHEMA unres OWNER TO ravon;
...
--
-- Name: geo_access; Type: TABLE; Schema: base; Owner: ravon
--

CREATE TABLE base.geo_access (
    geo_acc_id bigint NOT NULL,
    user_id bigint,
    ...
    asn bigint,
    aso character varying(100)
);


ALTER TABLE base.geo_access OWNER TO ravon;

--
-- Name: geo_access_basic_seq; Type: SEQUENCE; Schema: base; Owner: ravon
--

CREATE SEQUENCE base.geo_access_basic_seq
...
ALTER SEQUENCE base.geo_access_basic_seq OWNER TO ravon;

--
-- Name: geo_access_geo_acc_id_seq; Type: SEQUENCE; Schema: base; Owner: ravon
--

ALTER TABLE base.geo_access ALTER COLUMN geo_acc_id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME base.geo_access_geo_acc_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: geo_location; Type: TABLE; Schema: base; Owner: ravon
--

CREATE TABLE base.geo_location (
    location_id integer NOT NULL,
    cont_code character varying(10),
    cont_name character varying(50),
    ctry_code character varying(10),
    ctry_name character varying(50),
    sub1_code character varying(20),
    sub1_name character varying(50),
    sub2_code character varying(20),
    sub2_name character varying(50),
...
ALTER TABLE base.geo_location OWNER TO ravon;

--
-- Name: geo_location_location_id_seq; Type: SEQUENCE; Schema: base; Owner: ravon
--

ALTER TABLE base.geo_location ALTER COLUMN location_id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME base.geo_location_location_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: sylt_content; Type: TABLE; Schema: public; Owner: ravon
--

CREATE TABLE public.sylt_content (
...
ALTER TABLE public.sylt_content OWNER TO ravon;

--
-- Name: sylt_resources; Type: TABLE; Schema: public; Owner: ravon
--

CREATE TABLE public.sylt_resources (
    id integer NOT NULL,
    sylt_code character varying(32) NOT NULL,
    category character varying(20) DEFAULT 'NODE'::character varying,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP
);


ALTER TABLE public.sylt_resources OWNER TO ravon;

--
-- Name: sylt_resources_id_seq; Type: SEQUENCE; Schema: public; Owner: ravon
--

CREATE SEQUENCE public.sylt_resources_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.sylt_resources_id_seq OWNER TO ravon;

--
-- Name: sylt_resources_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: ravon
--

ALTER SEQUENCE public.sylt_resources_id_seq OWNED BY public.sylt_resources.id;


--
-- Name: sylt_structure; Type: TABLE; Schema: public; Owner: ravon
--

CREATE TABLE public.sylt_structure (
...
--
-- Name: sylt_resources id; Type: DEFAULT; Schema: public; Owner: ravon
--

ALTER TABLE ONLY public.sylt_resources ALTER COLUMN id SET DEFAULT nextval('public.sylt_resources_id_seq'::regclass);
...
COPY base.geo_access (geo_acc_id, user_id, access_time, ip, location_id, geoname_id, latitude, longitude, acc_radius, network, asn, aso) FROM stdin;
1	10000000000	2026-01-22 15:27:09.510866	131.38.173.92	1	\N	37.751	-97.822	1000	131.38.0.0/16	399	AFCONC-BLOCK1-AS
2	10000000000	2026-01-22 15:27:09.543868	131.46.237.185	1	\N	37.751	-97.822	1000	131.46.0.0/16	56	DNIC-AS-00056
3	10000000000	2026-01-22 15:27:09.55288	65.248.36.175	2	5364940	34.7148	-117.8756	500	65.248.32.0/19	701	UUNET
4	10000000000	2026-01-22 15:27:09.560878	104.134.196.157	3	5375480	37.3859	-122.0882	20	104.134.196.0/24	395973	GOOGLE-2
...
--
-- Data for Name: geo_location; Type: TABLE DATA; Schema: base; Owner: ravon
--

COPY base.geo_location (location_id, cont_code, cont_name, ctry_code, ctry_name, sub1_code, sub1_name, sub2_code, sub2_name, city_name, time_zone, locale_code, postcode) FROM stdin;
1	NA	North America	US	United States	Unknown	Unknown	Unknown	Unknown	Unknown	America/Chicago	en	Unknown
2	NA	North America	US	United States	CA	California	CA	California	Lancaster	America/Los_Angeles	en	93535
3	NA	North America	US	United States	CA	California	CA	California	Mountain View	America/Los_Angeles	en	94035
4	NA	North America	US	United States	CA	California	CA	California	San Jose	America/Los_Angeles	en	95129
5	NA	North America	US	United States	CA	California	CA	California	Lincoln	America/Los_Angeles	en	95648
6	LOC	Local	LOC	Local	LOC	Local	LOC	Local	Local	Local	en	Local
\.
...
10000000058	Test Gen Music Subtitle	flac	10000000006		10000000000	2026-01-30	/media/019c0dc7-72ca-7202-b973-842cf42d9975.flac
\.
...
51a47186-178b-4371-97ce-db371d66c87a	1.0.34.9100.beta.3.aic	1. Fix Bugs	2025-05-28 14:23:48+08
f6b92df1-cc43-4e8d-bcc8-fd48de1b7cf1	1.1.7.1000.release.1.aic	1. Fix Bugs	2025-05-28 14:23:48+08
0528d0f9-1037-4669-9c98-b04a4f207260	1.3.83.1100.beta.1.aic	1. Fix Bugs	2025-05-28 14:23:48+08
...
10000000030	10000000012	10000000000	0	2026-01-23 17:33:52.368729	14	2024-07-17 00:25:02
...
10000000082	10000000058	10000000000	0	2026-01-30 15:21:52.475092	1	2026-01-30 15:21:52.475092
10000000053	10000000021	10000000000	0	2026-01-23 18:01:48.654157	8	2025-12-07 15:12:15
10000000072	10000000048	10000000000	0	2026-01-16 22:46:12.239101	2	2026-01-16 22:45:35.417435
10000000081	10000000057	10000000000	0	2026-01-25 11:06:49.960098	4	2026-01-24 22:58:16.115593
...
--
-- Data for Name: sylt_content; Type: TABLE DATA; Schema: public; Owner: ravon
--

COPY public.sylt_content (resource_id, lang_code, basic_info, spec_info, stuff_info, source_info) FROM stdin;
\.


--
-- Data for Name: sylt_resources; Type: TABLE DATA; Schema: public; Owner: ravon
--

COPY public.sylt_resources (id, sylt_code, category, created_at) FROM stdin;
\.


--
-- Data for Name: sylt_structure; Type: TABLE DATA; Schema: public; Owner: ravon
--

COPY public.sylt_structure (parent_id, child_id) FROM stdin;
\.
...
SELECT pg_catalog.setval('base.geo_access_basic_seq', 10000000005, true);
...
SELECT pg_catalog.setval('base.geo_access_geo_acc_id_seq', 16, true);


--
-- Name: geo_location_location_id_seq; Type: SEQUENCE SET; Schema: base; Owner: ravon
--

SELECT pg_catalog.setval('base.geo_location_location_id_seq', 6, true);
...
SELECT pg_catalog.setval('inver.files_file_id_seq', 10000000058, true);
...
--
-- Name: sylt_resources_id_seq; Type: SEQUENCE SET; Schema: public; Owner: ravon
--
...
--
-- Name: geo_access geo_access_pkey; Type: CONSTRAINT; Schema: base; Owner: ravon
--

ALTER TABLE ONLY base.geo_access
    ADD CONSTRAINT geo_access_pkey PRIMARY KEY (geo_acc_id);


--
-- Name: geo_location geo_location_cont_code_sub1_code_sub2_code_city_name_key; Type: CONSTRAINT; Schema: base; Owner: ravon
--

ALTER TABLE ONLY base.geo_location
    ADD CONSTRAINT geo_location_cont_code_sub1_code_sub2_code_city_name_key UNIQUE (cont_code, sub1_code, sub2_code, city_name);


--
-- Name: geo_location geo_location_pkey; Type: CONSTRAINT; Schema: base; Owner: ravon
--
...
--
-- Name: sylt_content sylt_content_pkey; Type: CONSTRAINT; Schema: public; Owner: ravon
--

ALTER TABLE ONLY public.sylt_content
    ADD CONSTRAINT sylt_content_pkey PRIMARY KEY (resource_id, lang_code);


--
-- Name: sylt_resources sylt_resources_pkey; Type: CONSTRAINT; Schema: public; Owner: ravon
--

ALTER TABLE ONLY public.sylt_resources
    ADD CONSTRAINT sylt_resources_pkey PRIMARY KEY (id);


--
-- Name: sylt_resources sylt_resources_sylt_code_key; Type: CONSTRAINT; Schema: public; Owner: ravon
--

ALTER TABLE ONLY public.sylt_resources
    ADD CONSTRAINT sylt_resources_sylt_code_key UNIQUE (sylt_code);


--
-- Name: sylt_structure sylt_structure_pkey; Type: CONSTRAINT; Schema: public; Owner: ravon
--

ALTER TABLE ONLY public.sylt_structure
    ADD CONSTRAINT sylt_structure_pkey PRIMARY KEY (parent_id, child_id);
...
CREATE INDEX idx_access_time ON base.geo_access USING btree (access_time);


--
-- Name: idx_geo_city; Type: INDEX; Schema: base; Owner: ravon
--

CREATE INDEX idx_geo_city ON base.geo_location USING btree (city_name);


--
-- Name: idx_geo_cont; Type: INDEX; Schema: base; Owner: ravon
--

CREATE INDEX idx_geo_cont ON base.geo_location USING btree (cont_code);


--
-- Name: idx_geoname_id; Type: INDEX; Schema: base; Owner: ravon
--

CREATE INDEX idx_geoname_id ON base.geo_access USING btree (geoname_id);


--
-- Name: idx_ip; Type: INDEX; Schema: base; Owner: ravon
--

CREATE INDEX idx_ip ON base.geo_access USING btree (ip);


--
-- Name: idx_location_id; Type: INDEX; Schema: base; Owner: ravon
--

CREATE INDEX idx_location_id ON base.geo_access USING btree (location_id);


--
-- Name: idx_user_id; Type: INDEX; Schema: base; Owner: ravon
--

CREATE INDEX idx_user_id ON base.geo_access USING btree (user_id);
...
--
-- Name: idx_sylt_content_lookup; Type: INDEX; Schema: public; Owner: ravon
--

CREATE INDEX idx_sylt_content_lookup ON public.sylt_content USING btree (resource_id, lang_code);


--
-- Name: idx_sylt_resource_code; Type: INDEX; Schema: public; Owner: ravon
--

CREATE UNIQUE INDEX idx_sylt_resource_code ON public.sylt_resources USING btree (sylt_code);


--
-- Name: idx_sylt_structure_child; Type: INDEX; Schema: public; Owner: ravon
--

CREATE INDEX idx_sylt_structure_child ON public.sylt_structure USING btree (child_id);


--
-- Name: idx_sylt_structure_parent; Type: INDEX; Schema: public; Owner: ravon
--

CREATE INDEX idx_sylt_structure_parent ON public.sylt_structure USING btree (parent_id);
...
--
-- Name: sylt_content sylt_content_resource_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ravon
--

ALTER TABLE ONLY public.sylt_content
    ADD CONSTRAINT sylt_content_resource_id_fkey FOREIGN KEY (resource_id) REFERENCES public.sylt_resources(id);


--
-- Name: sylt_structure sylt_structure_child_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ravon
--

ALTER TABLE ONLY public.sylt_structure
    ADD CONSTRAINT sylt_structure_child_id_fkey FOREIGN KEY (child_id) REFERENCES public.sylt_resources(id);


--
-- Name: sylt_structure sylt_structure_parent_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ravon
--

ALTER TABLE ONLY public.sylt_structure
    ADD CONSTRAINT sylt_structure_parent_id_fkey FOREIGN KEY (parent_id) REFERENCES public.sylt_resources(id);
...
\unrestrict y5aKQCKnbUIHlRiIY1xRiUhKRtjKvcl9plPhIxUF156BjEemEKwNK5BIGNWxves
