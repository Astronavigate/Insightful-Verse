...
\restrict wZcEViTFJNIc4AYB66fdR1qnAEx03CXObMBPXJVxCUHfgjyDE4UNrRWwYIdOcWr
...
SELECT pg_catalog.setval('inver.collection_items_collection_item_id_seq', 7, true);
...
SELECT pg_catalog.setval('inver.collections_collection_id_seq', 1, true);
...
SELECT pg_catalog.setval('inver.courses_course_id_seq', 1, true);
...
SELECT pg_catalog.setval('inver.files_file_id_seq', 1, true);
...
SELECT pg_catalog.setval('inver.view_records_record_id_seq', 1, true);
...
\unrestrict wZcEViTFJNIc4AYB66fdR1qnAEx03CXObMBPXJVxCUHfgjyDE4UNrRWwYIdOcWr
