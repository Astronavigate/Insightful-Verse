...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ '7aa32bcf-d329-11f0-ba51-005056c00001:1-647';
...
CREATE TABLE `collection_items` (
  ...
  `item_type` enum('course','file') NOT NULL,
...
CREATE TABLE `comments` (
  ...
  `type` enum('course','file','collection') NOT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=10000000043 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `likes_dislikes` (
  ...
  `user_id` bigint NOT NULL,
  `content_type` enum('course','file','collection','comment') NOT NULL,
  `related_id` bigint NOT NULL,
...
CREATE TABLE `third_party_accounts` (
  ...
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`),
  CONSTRAINT `third_party_accounts_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `third_party_accounts` WRITE;
/*!40000 ALTER TABLE `third_party_accounts` DISABLE KEYS */;
/*!40000 ALTER TABLE `third_party_accounts` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `users` VALUES (10000000000,'Ravon Gonzales','ravongonzales@gmail.com','+14152836259','$argon2id$v=19$m=65536,t=3,p=1$55CmHLytIqlWdQguB+chGw$uHhLgR88RwGNhxu35KmFSQSfW2VwLotYWjHUtfdDEXI',NULL,'infinite','/image/system/avatar/default.png'),(10000000001,'114','1078959112@qq.com','+8615640993693','$argon2id$v=19$m=65536,t=3,p=1$0nckdWH+mGAO1TtbWJQQuQ$U7S2iuL56DyaHYsyWdIIntqnsJenaWTACBQYhJwCgY0',NULL,'normal','/image/system/avatar/default.png'),(10000000002,'长青','1243637340@qq.com','17347140977','$argon2id$v=19$m=65536,t=3,p=1$0nckdWH+mGAO1TtbWJQQuQ$U7S2iuL56DyaHYsyWdIIntqnsJenaWTACBQYhJwCgY0',NULL,'normal','/image/system/avatar/default.png'),(10000000003,'Tester','Tester','0000000000','$argon2id$v=19$m=65536,t=3,p=1$mH60WgbcZmHsxhzaexLdbg$5qRcBGu1bdso0xgBXZT5e7N8EGKB4V0ua9lEu+0NEvw',NULL,'normal','/image/system/avatar/default.png'),(10000000004,'Test','ivadmin@test.ravon.tech','+8618141192117','$argon2id$v=19$m=65536,t=3,p=1$OnrXIvvI9Lsu/nBm3DXjkw$U6ZpOa6d9yANMlzRM/5fLURw0Ylih7Dte+Au/f4grDc',NULL,'admin','/image/system/avatar/default.png');
...
-- Dump completed on 2025-12-31 16:24:02
