...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ '7aa32bcf-d329-11f0-ba51-005056c00001:1-162';
...
) ENGINE=InnoDB AUTO_INCREMENT=10000000030 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=10000000056 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ivversion` VALUES ('019b1da5-6a40-7deb-89d3-c1f6040f828f','1.3.71.1000.alpha.4.aix','Added DOCX, XLSX, and PPT reader'),('0a54bac6-9861-11f0-a41f-6b3c1ccfef93','1.1.4.1100.beta.2.aix','Fixed an error when the logged in user does not exist'),('1009d1c0-3c4e-11f0-8b9c-a51ae60b576a','1.1.0.1000.beta.1.aix','Update package name; Fix some bugs in history records; Add AiBot page.'),('1792e216-3863-11ef-921f-005056c00001','1.0.16.1000.alpha.0','Initial release'),('179356c8-3863-11ef-921f-005056c00001','1.0.16.1000.alpha.1','Optimize code logic and add the function of modifying personal information'),('1793ca14-3863-11ef-921f-005056c00001','1.0.18.1100.alpha.2','Fixed some known bugs'),('17942f51-3863-11ef-921f-005056c00001','1.0.19.1000.alpha.3','Adjusted the logout page logic and add account unregsiter'),('17949a88-3863-11ef-921f-005056c00001','1.0.21.1000.alpha.4','Adjusted web page architecture'),('2439cb90-3c90-11f0-a211-1b03c85e0ae4','1.1.4.1000.beta.2.aix','Added AiBot function to support exporting chat history; optimized AiBot page; adjusted AiBot Server logic.'),('2d36395a-434a-11ef-acd1-005056c00001','1.0.29.5000.alpha.6','1. Added the function of course; 2. Adjust view history; 3. Support more type of viewer; 4. Support admin operation; 5. Fix some known bugs.'),('2f2c0b4c-a367-11f0-a218-325096b39f47','1.2.51.1000.beta.1.aix','Added support for 23 languages ​including Simplified Chinese, French, German, etc.'),('49cfc210-d367-11f0-877c-752b2124c36f','1.3.63.1000.alpha.1.aix','1. Introduce the navigation bar designed by Waveflux; 2. Redesign the video playback page.'),('67cc5000-3b9e-11f0-8b9c-a51ae60b576a','1.0.34.1000.beta.2.aix','Fixed the bug that database automatic backup was not saved; Fixed the bug that users would get an error when directly turning pages on the browsing history page; Optimized the user history structure.'),('7aff4c00-3bbb-11f0-8b9c-a51ae60b576a','1.0.34.9000.beta.3.aix','Dynamically display the system version; Optimize user history storage; Display user browsing times, first and last browsing time; Fix some known bugs.'),('9bc4dd30-d32b-11f0-9dbd-d964415d14f3','1.2.59.100.release.aix','Adjusted audio player interface'),('9dd2f0a9-4349-11ef-acd1-005056c00001','1.0.22.5000.alpha.5','Adjusted web architecture'),('ac1f6117-9cfa-11f0-922a-e3cd01e5ca3b','1.1.7.1000.zeta.0.aix','Added multi-language options (currently only supports English); Fixed some known bugs.'),('cbd2af32-a37b-11f0-9865-325096b39f47','1.2.55.1000.beta.2.aix','Fixed errors caused by the navigation bar on some pages; Fixed the error that administrators could not modify or delete courses on the course page; Fixed the error that administrators jumped back to the course page after deleting a course on the search page; Adjusted the style of the language selection page.'),('e24e0920-3b9b-11f0-8b9c-a51ae60b576a','1.0.30.1000.beta.1.aix','Added automatic database backup for Linux servers');
...
-- Dump completed on 2025-12-15  0:21:01
