...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ '7aa32bcf-d329-11f0-ba51-005056c00001:1-200';
...
CREATE TABLE `annotations` (
  ...
  `color` varchar(16) DEFAULT '#ffd54f',
...
INSERT INTO `annotations` VALUES (2,10000000000,10000000033,'bookmark','epubcfi(/6/4[item1]!/4/1:0)','text label mark',NULL,'2025-12-15 23:32:35','2025-12-15 23:32:35'),(4,10000000000,10000000033,'bookmark','epubcfi(/6/10[item4]!/4/2[a004]/1:0)','test mark 2',NULL,'2025-12-15 23:33:48','2025-12-15 23:33:48');
...
) ENGINE=InnoDB AUTO_INCREMENT=10000000034 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=10000000060 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-12-15 23:49:03
